...
class Model_verifikasi_ssh extends Model
{
	protected $table = 'tb_ssh_verifikasi';
	protected $useTimestamps = true;
	protected $useAutoIncrement = false;
	protected $primaryKey = 'ssh_id';
	protected $allowedFields = ['ssh_id', 'verifikasi', 'verifikasi_keterangan', 'nm_verifikator', 'tahun', 'opd_id', 'created_by', 'updated_by', 'created_at', 'updated_at'];
