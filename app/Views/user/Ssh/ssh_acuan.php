			...
			foreach ($ssh as $row) : ?>
				<tr class="">
					...
					<td class="text-center align-baseline">
						<?php if ($row['verifikasi'] == 'perbup') : ?>
							<a class="btn btn-info btn-circle btn-xs" href="<?= base_url() . '/user/ssh/ssh_acuan/acuan_edit/' . $row['id_ssh']; ?>">
								<i class="nav-icon fas fa-pen-alt"></i>
							</a>
						<?php elseif ($row['verifikasi'] == 'lolos') : ?>
								...
								<a class="dropdown-item" href="#">
									<div class="media">
										<div class="media-body">
											...
											<p class="text-sm"><?= $row['nm_verifikator']; ?></p>
										</div>
									</div>
								</a>
							</div>
						<?php elseif ($row['verifikasi'] == 'perbup_edit') : ?>
