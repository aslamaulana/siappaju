...
<div class="card-body">
	<table class="table table-bordered">
		<tr>
			<td style="width: 140px;;"><b>Paket :</b></td>
			<td><?= $hspk1['hspk_paket']; ?></td>
		</tr>
		<tr>
			<td><b>Spesifikasi :</b></td>
			<td><?= $hspk1['hspk_spesifikasi']; ?></td>
		</tr>
	</table><br>
	<table id="example2" class="table table-bordered display nowrap table-sm" cellspacing="0">
		...
		<tbody>
			...
			<tr style="font-weight: bold;">
				...
				<td class="text-right"><?= isset($num['A']) ? number_format((float)array_sum($num['A']), 2, ',', '.') : '-'; ?></td>
			</tr>
			<!--Tenaga Kerja-->
			...
			<tr style="font-weight: bold;">
				...
				<td class="text-right"><?= isset($num['B']) ? number_format((float)array_sum($num['B']), 2, ',', '.') : '-'; ?></td>
			</tr>
			<!--Bahan-->
			<!--Peralatan-->
			<tr style="background: aliceblue;">
			...
			<tr style="font-weight: bold;">
				...
				<td class="text-right"><?= isset($num['C']) ? number_format((float)array_sum($num['C']), 2, ',', '.') : '-'; ?></td>
			</tr>
			<tr style="font-weight: bold;">
				...
				<td class="text-right">
					...
					echo number_format((float)(array_sum($AA) + array_sum($BB) + array_sum($CC)), 2, ',', '.');
					?>
				</td>
			</tr>
			<!-- <tr>
				...
				<td class="text-right"><?php // isset($num['A']) || isset($num['B']) || isset($num['C']) ? number_format((float)((array_sum($num['A']) + array_sum($num['B']) + array_sum($num['C'])) * 15) / 100, 2, ',', '.') : '-'; 
										?></td>
				<td></td>
			</tr>
			<tr style="font-weight: bold;">
				...
				<td></td>
				<td class="text-right"><?php // isset($num['A']) || isset($num['B']) || isset($num['C']) ? number_format((float)(array_sum($num['A']) + array_sum($num['B']) + array_sum($num['C'])) + (((array_sum($num['A']) + array_sum($num['B']) + array_sum($num['C'])) * 15) / 100), 2, ',', '.') : '-'; 
										?></td>
				<td></td>
			</tr> -->
			<!--Peralatan-->
