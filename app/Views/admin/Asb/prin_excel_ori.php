	...
	<table>
		<tbody>
			...
			<?php foreach ($rincian_objek as $ros) : ?>
				...
				<?php $asb = $db->table('tb_asb')->select('tb_asb.*')->join('tb_asb_verifikasi', 'tb_asb.id_asb = tb_asb_verifikasi.asb_id', 'LEFT')->getWhere(['tb_asb.jenis_rincian_objek_sub_id' => $ros['id_jenis_rincian_objek_sub'], 'tb_asb.tahun' => $_SESSION['tahun'], 'tb_asb_verifikasi.verifikasi' => 'lolos', 'tb_asb.opd_id' => $row['opd_id']])->getResultArray(); ?>
