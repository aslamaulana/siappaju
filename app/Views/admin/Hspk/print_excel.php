...
<?php foreach ($hspk as $row) : ?>
	<table>
		<tbody>
			...
			<?php $rincian_objek = $db->table('tb_hspk')->DISTINCT('tb_hspk.id_hspk')->select('tb_jenis_rincian_objek_sub.jenis_rincian_objek_sub')->select('tb_jenis_rincian_objek_sub.id_jenis_rincian_objek_sub')->join('tb_jenis_rincian_objek_sub', 'tb_hspk.jenis_rincian_objek_sub_id = tb_jenis_rincian_objek_sub.id_jenis_rincian_objek_sub', 'LEFT')->join('tb_verifikasi', 'tb_hspk.id_hspk = tb_verifikasi.hspk_id', 'LEFT')->getWhere(['tb_verifikasi.verifikasi' => 'lolos'])->getResultArray(); ?>
			...
			<?php foreach ($rincian_objek as $ros) : ?>
				...
				<?php $hspk = $db->table('tb_hspk')->select('tb_hspk.*')->join('tb_verifikasi', 'tb_hspk.id_hspk = tb_verifikasi.hspk_id', 'LEFT')->getWhere(['tb_hspk.jenis_rincian_objek_sub_id' => $ros['id_jenis_rincian_objek_sub'], 'tb_verifikasi.verifikasi' => 'lolos'])->getResultArray(); ?>
